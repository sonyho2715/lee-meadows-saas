      ...
      <main className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <Card className="border-2 border-yellow-500/50 bg-gradient-to-br from-yellow-900/20 to-amber-950/20 mb-8">
          ...
          <CardContent className="text-gray-200 space-y-3">
            ...
            <p>
              By accessing or using the TradePulse AI AI Trading investment services through TradePulse AI, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our services.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-8">
          ...
          <Card className="border-yellow-500/20 bg-gradient-to-br from-[#1a1f3a] to-[#0a0e27]">
            ...
            <CardContent className="text-gray-300 space-y-4">
              ...
              <p>
                To access our investment services, you must create an account by contacting TradePulse AI and completing our registration process. You agree to provide accurate, current, and complete information during registration and to update such information to keep it accurate, current, and complete.
              </p>
          ...
          <Card className="border-yellow-500/20 bg-gradient-to-br from-[#1a1f3a] to-[#0a0e27]">
            ...
            <CardContent className="text-gray-300 space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <p>Representative: TradePulse AI</p>
              </div>
            </CardContent>
          </Card>
        </div>
